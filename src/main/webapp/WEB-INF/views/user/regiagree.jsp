...
<input type='checkbox'
       ...
       <b style="font-size: 15px; font-family: Malgun Gothic,돋움;"><label for="reqAll" style="text-decoration: underline;">이용약관, 개인정보 수집 및 이용, 이메일 수신(선택)에 모두 동의합니다.</label></b>
</div>

<div align="center">
<table>
<b style="font-size: 15px; font-family: Malgun Gothic,돋움;">[필수]이용약관 동의</b>
<td>
    <textarea rows="10" cols="80" style="font-size: 12px; font-family: Malgun Gothic,돋움;">
    제1조(목적)
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
    ...
    <br>
    <span style="font-size: 13px; font-family: Malgun Gothic,돋움;">이용약관에 동의하십니까?</span>
<input type='checkbox'
       name='req' 
       value='req'
       id="req"
       onclick='checkSelectAll()'/> <b><label for="req" style="font-size: 14px; font-family: Malgun Gothic,돋움;">동의함</label></b>
</td>
</table>
</div>
<!-- <br /> -->
...
<table>
<b style="font-size: 15px; font-family: Malgun Gothic,돋움;">[필수] 개인정보 수집 및 이용 동의</b>
<td>
    <textarea rows="10" cols="80" style="font-size: 12px; font-family: Malgun Gothic,돋움;">
■ 수집하는 개인정보 항목
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.    
  ...
  <br>
 <span style="font-size: 13px; font-family: Malgun Gothic,돋움;">개인정보 수집 및 이용에 동의하십니까?</span> 
<input type='checkbox' 
       name='req2' 
       value='req2'
       id="req2"
       onclick='checkSelectAll()' /> <b><label for="req2" style="font-size: 14px; font-family: Malgun Gothic,돋움;">동의함</label></b>
</td>
</table>
</div>
<!-- <br /> -->
...
<table>
<b style="font-size: 15px; font-family: Malgun Gothic,돋움;">[선택] 쇼핑정보 수신 동의</b>
<td>
    <textarea rows="8" cols="80" style="font-size: 12px; font-family: Malgun Gothic,돋움;">
...
선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.
    ...
    <br>
<span style="font-size: 13px; font-family: Malgun Gothic,돋움;">이메일 수신을 동의하십니까?</span> 
<input type='checkbox' 
       name='req3' 
       value='req3'
       id="req3"
       onclick='checkSelectAll()' /> <b><label for="req3" style="font-size: 14px; font-family: Malgun Gothic,돋움;">동의함</label></b>
   </td>
 </table>
<br><br>
	<input type="button" value="확인" onclick="chk()" class="btn btn-outline-dark" style="font-size: 13px; font-family: Malgun Gothic,돋움;">
	<input type="button" value="취소" onclick="javascript:window.location='../main/main.jsp'" class="btn btn-outline-gray btn1" style="font-size: 13px; font-family: Malgun Gothic,돋움;"/>
